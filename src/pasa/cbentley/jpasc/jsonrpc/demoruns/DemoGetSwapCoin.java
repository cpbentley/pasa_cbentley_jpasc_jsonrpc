...
public class DemoGetSwapCoin extends DemoAbstract {

   public DemoGetSwapCoin() {
      super();
   }

   public static void main(String[] args) {
      DemoGetSwapCoin demo = new DemoGetSwapCoin();
      demo.run();
   }
   ...
   public void run() {
      ...
      requestAccounts(mySession, ITechPascRPC.STATUS_TYPE_FOR_SWAP_COIN);
   }
