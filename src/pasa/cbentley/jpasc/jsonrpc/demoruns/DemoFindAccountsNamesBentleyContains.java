...
public class DemoFindAccountsNamesBentleyContains extends DemoAbstract {

   public DemoFindAccountsNamesBentleyContains() {
      super();
   }

   public static void main(String[] args) {
      DemoFindAccountsNamesBentleyContains demo = new DemoFindAccountsNamesBentleyContains();
      demo.run();
   }
